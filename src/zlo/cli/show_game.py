...
from zlo.domain.utils import get_house_from_list_by_house_id, get_houses_from_list_of_house_ids
        ...
        while str_date != 'exit':
            ...
            for game in games:
                ...
                for house in game_info.houses:
                    print(
                        f"\tHouse:"
                        f"   Nickname: '{tx.players.get_by_id(house.player_id).nickname}'"
                        f"   Role: {house.role}"
                        f"   Slot: {house.slot}"
